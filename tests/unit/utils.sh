...
KW_MAIL_CONFIG_SAMPLE="$SAMPLES_DIR/send_patch.config"
...
# Note: For single-line outputs, the use of assertEquals is highly recommended
# over compare_command_sequence.
#
